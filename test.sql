...
drop table orders;
create table orders(
    o_orderid integer PRIMARY KEY AUTOINCREMENT,
...
values 
    ...
    (19,'AMZN');
--
insert into orders (o_userid, o_ticker, o_quantity, o_tickerprice, o_orderdate)
values 
    (1,'APPL',2,14.02,'2014-03-02'),
    (1,'AFL',3,34.23,'2014-03-02'),
    (1,'ADSK',1,40.21,'2014-03-03'),
    (1,'FFIV',4,80.96,'2014-03-23'),
    (2,'APPL',10,13.95,'2014-03-29'),
    (2,'GOOGL',2,405.87,'2014-04-01'),
    (2,'FOX',4,20.45,'2014-04-03'),
    (2,'HAL',2,35.67,'2014-04-05'),
    (2,'HP',5,32.21,'2014-04-08'),
    (2,'NDAQ',7,45.24,'2014-04-08'),
    (3,'NVDA',1,11.15,'2014-04-09'),
    (3,'APPL',5,16.97,'2014-04-12'),
    (3,'PYPL',2,39.23,'2014-04-12'),
    (3,'ROP',3,115.03,'2014-04-13'),
    (3,'SIG',4,65.55,'2014-04-15'),
    (3,'SNA',9,32.22,'2014-04-28'),
    (4,'TAP',12,42.12,'2014-05-05'),
    (4,'TRIP',10,12.95,'2014-05-20'),
    (4,'TSCO',1,50.03,'2014-05-28'),
    (5,'T',23,32.39,'2014-06-17'),
    (5,'APPL',18,20.19,'2014-06-25'),
    (5,'WAT',43,103.44,'2014-06-29'),
    (5,'XRAY',1,31.18,'2014-07-04'),
    (5,'ABC',21,40.00,'2014-07-15'),
    (6,'ADS',3,130.45,'2014-07-30'),
    (6,'AKAM',19,30.23,'2014-08-09'),
    (7,'AMZN',2,130.99,'2014-08-18'),
    (7,'BSX',11,3.45,'2014-08-25'),
    (7,'CL',10,78.00,'2014-09-01'),
    (7,'COP',12,89.03,'2014-09-14'),
    (8,'AAL',2,18.32,'2014-09-27'),
    (8,'CSCO',13,27.41,'2014-10-10'),
    (8,'C',1,56.92,'2014-10-19'),
    (8,'IBM',28,155.19,'2014-10-30'),
    (8,'LB',5,50.00,'2014-11-07'),
    (9,'GOOGL',21,331.19,'2014-11-13'),
    (9,'APPL',3,11.20,'2014-11-26'),
    (9,'FAST',31,55.23,'2014-12-01'),
    (10,'KEY',8,4.32,'2014-12-05'),
    (11,'AAL',3,22.21,'2014-12-16'),
    (11,'AMZN',2,230.22,'2014-12-21'),
    (11,'COP',4,45.11,'2015-01-19'),
    (12,'IBM',17,200.13,'2015-01-28'),
    (12,'APPL',13,20.45,'2015-02-02'),
    (12,'XRAY',2,43.99,'2015-02-16'),
    (12,'C',15,40.56,'2015-02-27'),
    (13,'JEC',13,55.65,'2015-03-07'),
    (13,'KMB',17,81.15,'2015-03-16'),
    (14,'KO',1,51.37,'2015-03-29'),
    (14,'LOW',13,62.31,'2015-04-06'),
    (14,'NUE',27,34.92,'2015-04-20'),
    (15,'APPl',12,63.42,'2015-05-06'),
    (15,'SBUX',11,30.54,'2015-05-17'),
    (16,'STZ',2,35.62,'2015-05-23'),
    (16,'GOOGL',13,385.12,'2015-05-02'),
    (17,'AMZN',19,249.38,'2015-05-14'),
    (17,'MSFT',31,26.10,'2015-05-30'),
    (2,'BTC',2,15384.03,'2015-06-02'),
    (3,'ETH',1,1000.00,'2015-06-18'),
    (9,'BTC',12,12023.45,'2015-06-20'),
    (10,'XRP',3,0.5,'2015-07-01');
